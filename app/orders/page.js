                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-gray-600">
                        {order.status === 'delivered' && 'Delivered on ' + new Date(order.deliveryDate).toLocaleDateString()}
                        {order.status === 'shipped' && 'Shipped on ' + new Date(order.shipDate).toLocaleDateString()}
